		    ...
		    <div id="content">
		    	<div class="container-fluid">				
					...
					<div class="content-wrap">							          			
	          			<cfquery name="disable_mfa" datasource="#Session.DSN#">
							delete
							from mfa
							Where active = '1'
						...
						<cfset Session.mfa_enabled = false>
						...
						<div class="row">
							<div class="col-lg-12">
								MFA Has been disabled on this account.
								<br>
								<br>
								You will need to delete the account on your Authenticator app as well.
							</div>
						</div>
