				...
				<div class="container-fluid">
					...
					<cfif Session.Add_Inventory_Modal_Status EQ 10>										
						...
						<cfquery name="insert_inventory" datasource="#Session.DSN#">
							...
							values 
							(
							<cfqueryparam value="#Session.inventory_db_uuid#" cfsqltype="cf_sql_longvarchar">,
							<cfqueryparam value="#Session.plant_category#" cfsqltype="cf_sql_longvarchar">,
							<cfqueryparam value="#Session.is_pre_inventory#" cfsqltype="cf_sql_integer">,
							<cfqueryparam value="#Session.is_purchased#" cfsqltype="cf_sql_integer">,
							<cfqueryparam value="#Session.is_propagated#" cfsqltype="cf_sql_integer">,
							<cfqueryparam value="#Session.quantity#" cfsqltype="cf_sql_integer">,
							<cfqueryparam value="#Session.cost#" cfsqltype="cf_sql_float">,
							<cfqueryparam value="#Session.shipping#" cfsqltype="cf_sql_float">,
