								...
								<table class="styled_picker stripe" id="universal_list_3">
									...
									<tbody>
										<cfloop query="get_inventory">
											...
											<tr>
												<td>
													#get_inventory.description#
												</td>
												<td>
													<cfif get_inventory.is_pre_inventory EQ 1>
														Yes
													<cfelse>
														No	
													</cfif>
												...
												<td>
													<cfif get_inventory.is_purchased EQ 1>
														Yes		
													<cfelse>
														No
													</cfif>													
												...
												<td>
													<cfif get_inventory.is_propagated EQ 1>
														Yes
													<cfelse>
														No				
													</cfif>
												...
												<td>
													#get_inventory.on_hand_qty#
												</td>
												<td>
													#DollarFormat(get_inventory.plant_cost)#
												</td>	
												<td>
